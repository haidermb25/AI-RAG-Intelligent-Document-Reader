...
# Initialize model and Groq client
...
# Function to clean response and exclude content within <think> </think> tags
def clean_response(response_content):
    # Use regular expression to remove content between <think> and </think> tags
...
if uploaded_file is not None:
    ...
    if query:
        with st.spinner("🔎 Searching for the answer..."):
            ...
            # Clean the response content to remove any content between <think> </think> tags
